        ...
        <div class="container">
            ...
            <div class="legal-content reveal">
                <div class="policy-hero-card">
                    <p>
                        Данная политика распространяется на персональные данные, предоставляемые клиентами <strong><?= $domainTitle ?></strong>. Мы используем их для оказания экспертных услуг по карьерному апгрейду, аналитики и эффективного взаимодействия в цифровой среде.
                    </p>
                </div>

                <div class="policy-notice">
                    <p>
                        <strong>Важное уведомление:</strong> <strong><?= $domainTitle ?></strong> оставляет за собой право обновлять положения Политики. Наши решения, которые меняют правила игры, требуют актуальных мер защиты. Предоставляя данные, вы соглашаетесь на их обработку методологиями, доказавшими эффективность в странах ЕС.
                    </p>
                </div>
                ...
                <div class="storage-info">
                    <div class="storage-item">
                        ...
                        <div>
                            ...
                            <span>До 75 лет в рамках архивных записей</span>
                        </div>
                    </div>
                    <div class="storage-item">
                        ...
                        <div>
                            ...
                            <span>Только добровольное предоставление</span>
                        </div>
                    </div>
                </div>
                <p>
                    Для предотвращения утечек мы используем передовую цифровую инфраструктуру. Уничтожение данных происходит по запросу клиента или при достижении целей карьерного консультирования.
                </p>
                ...
                <div class="data-collection-grid">
                    <div class="data-box">
                        ...
                        <ul>
                            <li>IP-адрес и время доступа в Риме (CET)</li>
                            <li>Источники перехода на <strong><?= $fullDomain ?></strong></li>
                            <li>Данные взаимодействия с 3D-элементами</li>
                        </ul>
                    </div>
                    <div class="data-box">
                        <h3><i class="fas fa-id-card"></i> Персонализация</h3>
                        <ul>
                            <li>Имя пользователя и сфера деятельности</li>
                            <li>E-mail и номер телефона (+39)</li>
                            <li>История запросов на менторство</li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="legal-list">
                    <li>Предоставление доступа к инновационной платформе роста.</li>
                    <li>Учет предпочтений при разработке новых стратегий дохода.</li>
                    <li>Информирование о карьерных инсайтах и предложениях в ЕС.</li>
                    <li>Обеспечение оперативной экспертной поддержки.</li>
                </ul>

                <h2>Использование Cookies</h2>
                <p>
                    Файлы cookie помогают нам анализировать трафик и сохранять ваши предпочтения (например, настройки региона Италия), чтобы сделать ваш путь к новой должности проще и быстрее.
                </p>

                <div class="rights-block">
                    <h2>Ваши права</h2>
                    <p>
                        Вы можете в любой момент отозвать согласие или запросить выгрузку своих данных. Для связи с командой <strong><?= $domainTitle ?></strong> используйте кнопку ниже:
                    </p>
                    <a href="mailto:hello@<?= $fullDomain ?>" class="contact-btn">
                        <i class="fas fa-envelope-open-text"></i> hello@<?= $fullDomain ?>
                    </a>
                </div>
            </div>
        </div>
